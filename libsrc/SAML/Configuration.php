...
class Configuration implements Utils\ClearableState
{
     ...
     * loaded from a file.
     *
     * @param Configuration $config  The configuration object to store
    ...
    public static function getInstance($instancename = 'simplesaml')
    {
        ...
        if ($instancename === 'simplesaml') {
            try {
                ...
                throw CriticalConfigurationError::fromException($e);
            }
        }
     ...
     *
     * @throws CriticalConfigurationError If the format of 'baseurlpath' is incorrect.
     *
     ...
     * @throws Exception If the file does not contain a valid PEM-encoded certificate, or there is no
