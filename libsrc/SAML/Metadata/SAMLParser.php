...
class SAMLParser
{
     ...
     *
     * @param EntityDescriptor $entityElement A \SAML2\XML\md\EntityDescriptor object which represents a
    ...
    /**
     *
     * @param EntityDescriptor|EntitiesDescriptor $element The element we should process.
     ...
     *
     * @param RoleDescriptor $element The element we should extract metadata from.
     ...
     * - 'keys': Array of associative arrays with the elements from parseKeyDescriptor:
     *
     * @param SSODescriptorType $element The element we should extract metadata from.
     * @param int|NULL                       $expireTime The unix timestamp for when this element should expire, or
     *                             NULL if unknown.
     *
     * @return array An associative array with metadata we have extracted from this element.
     ...
     *
     * @param SPSSODescriptor $element The element which should be parsed.
     * @param int|NULL                     $expireTime The unix timestamp for when this element should expire, or
     *                             NULL if unknown.
     * @return void
     */
     ...
     *
     * @param IDPSSODescriptor $element The element which should be parsed.
     * @param int|NULL                      $expireTime The unix timestamp for when this element should expire, or
     *                             NULL if unknown.
     * @return void
     */
     ...
     *
     * @param AttributeAuthorityDescriptor $element The element which should be parsed.
     ...
     *
     * @param Organization $element The Organization element.
     * @return void
     */
     ...
     *
     * @param ContactPerson $element The ContactPerson element.
     * @return void
     */
     ...
     *
     * @param AttributeConsumingService $element The AttributeConsumingService to parse.
     ...
     *
     * @param EndpointType $element The element which should be parsed.
     *
     ...
     *
     * @param KeyDescriptor $kd The KeyDescriptor element.
     *
