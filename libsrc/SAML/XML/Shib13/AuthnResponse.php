...
{
    /**
     * @var Validator|null This variable contains an XML validator for this message.
     */
     ...
     *
     * @param Configuration $idp Metadata for the IdP the response is sent from.
     * @param Configuration $sp Metadata for the SP the response is sent to.
